    ...
    return (
        <>
            ...
            <form onSubmit={(e) => e.preventDefault()} style={{ width: "600px", margin: "20px auto" }}>
                <h3 className='text-center text-white' >Signup Account</h3>
                <div className="mb-3">
                ...
                <div className="mb-3 form-check">
                    ...
                    <Link to="/login" className=' register mx-2 link'>Login</Link>
                </div>
                <div>
                    {
                ...
                <button onClick={handlesignup} type="submit" className="btn btn-dark" disabled={(isLoading == true) ? true : false} > {isLoading ? "Loading..." : "Register"}</button>
            </form>
        </>
    )
}
